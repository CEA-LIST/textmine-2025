...
current_run="${project_path}/results/Eider/${dataset}/${model_name}_finetuning_cross_valid_pred+rb_evidences_bs=${batch_size}_run=${run_number}__${datetime}"
...
# training
python -u Eider/train_cross_validation.py \
    --data_dir $data_dir \
