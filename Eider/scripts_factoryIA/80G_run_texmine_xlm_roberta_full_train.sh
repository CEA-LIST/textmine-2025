...
current_run="${project_path}/results/Eider/${dataset}/${model_name}_finetuning_full_train_rb_evidences_bs=${batch_size}_run=${run_number}__${datetime}"
...
# training
python -u Eider/train_on_full_training_set.py \
    --data_dir $data_dir \
    --transformer_type xlm-roberta \
    --model_name_or_path $model_path \
    --data_file_with_silver_evidence data_with_silver_evidence.json \
    --test_file_with_silver_evidence test_01-07-2024_with_silver_evidence.json \
