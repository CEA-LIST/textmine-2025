...
current_run="${project_path}/results/LACE/${dataset}/${model_name}_finetuning_cross_valid_bs=${batch_size}_run=${run_number}__${datetime}"
...
# training
python -u LACE/train_cross_validation.py \
    --data_dir $data_dir \
